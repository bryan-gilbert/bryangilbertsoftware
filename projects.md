...
- Technical skills: VUE.js, Vuex, React, Webpack, Babel, JavaScript, Node JS, Nginx, Express, Debian, UFW, HTTPs, Jade (Pug), Docker, Docker-compose, MongoDB, SCSS,  Git, Mocha, Chai, Supertest, and more
